...
<div class="w-sidebar h-full bg-surface-container-lowest border-r border-outline-variant/30 flex flex-col justify-between p-md shrink-0 select-none">
    ...
    <div>
        <div class="flex items-center gap-sm mb-xl px-xs h-14 shrink-0">
            ...
            <div>
                <h1 class="text-title-md font-bold text-primary tracking-tight leading-tight">Eventoria</h1>
    ...
    <div class="border-t border-outline-variant/20 pt-md space-y-xs">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full flex items-center gap-md px-md py-sm text-error hover:bg-error-container/40 rounded-xl transition-all text-left group">
