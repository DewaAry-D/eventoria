...
@if($inTable)
    <tr>
        <td colspan="{{ $colspan }}" class="p-xl text-center bg-transparent border-none">
            <div class="flex flex-col items-center justify-center text-center select-none min-h-[16rem] animate-fade-in">
...
@else
    <div class="flex flex-col items-center justify-center text-center p-xl select-none min-h-[16rem] bg-surface-container-lowest rounded-2xl border border-outline-variant/30 shadow-sm animate-fade-in w-full">
