...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Admin Dashboard - Eventoria</title>
    ...
    <body class="bg-surface text-on-surface antialiased" x-data="{ sidebarOpen: false }">
        ...
        <header class="flex md:hidden items-center justify-between bg-surface-container-lowest border-b border-outline-variant/30 px-md py-xs sticky top-0 z-30 h-14 w-full shrink-0 select-none">
            ...
            <div class="font-bold text-primary tracking-tight text-body-lg">
                Eventoria Admin
            </div>
        ...
        <div class="flex min-h-screen">
            ...
            <div @click="sidebarOpen = false" x-show="sidebarOpen" x-transition.opacity class="fixed inset-0 bg-black/40 z-30 md:hidden"></div>
